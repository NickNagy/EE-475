...
unsigned char tempNewMeasurement;
unsigned char bpNewMeasurement;
unsigned char pulseNewMeasurement;
unsigned char respirationNewMeasurement;

unsigned short tempAlarmCount;
unsigned short bpAlarmCount;
unsigned short pulseAlarmCount;
unsigned short respirationAlarmCount;
